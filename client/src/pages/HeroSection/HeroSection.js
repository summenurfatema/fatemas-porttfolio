...
const HeroSection = () => {
    ...
    return (
        <div className='flex flex-col lg:flex-row justify-between items-center px-5 py-5 md:px-14  lg:px-12 xl:px-10 3xl:px-14 4xl:px-14 md:py-10 3xl:h-screen relative'>
            ...
            <div className='w-full lg:w-6/12 space-y-3 lg:space-y-4 mb-4 lg:mb-0'>
           ...
           <a href='https://www.facebook.com/summenurfatema/' target='blank'> 
           ...
           <a href='https://github.com/summenurfatema/' target='blank'> 
           ...
           <a href='https://www.linkedin.com/in/summenurfatema/' target='blank'> 

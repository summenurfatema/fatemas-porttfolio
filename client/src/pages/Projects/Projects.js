...
const Projects = () => {
  return (
    <div className="  px-5 py-5 md:px-14  lg:px-12 xl:px-20 md:py-10 relative">
      <h1 className="text-gray-800 text-5xl">
        Latest projects <span className="h-5 w-10">___</span>
      </h1>
      <div className="flex justify-evenly items-center">
        {/* 1 */}
        <div className=" border-t-2 border-gray-800 mt-60">
          <div className="flex items-center space-x-4 my-4 relative">
            <>
              ...
              <div className="h-12 w-12 bg-[#8670EF] rounded-full"></div>
            </>
            <p className="text-gray-800 text-3xl font-semibold">CELO</p>
          </div>
          <div className="">
        ...
        <div className=" border-t-2 border-gray-800">
          <div className="flex items-center space-x-4 my-4 relative">
            ...
            <p className="text-gray-800 text-3xl font-semibold">EARTHLY</p>
          </div>
          <div className="">
        ...
        {/* 3 */}
        <div className=" border-t-2 border-gray-800 -mt-52">
          <div className="flex items-center space-x-4 my-4 relative">
            <>
              <BsArrowUpRight className="text-white text-3xl absolute left-6 top-2 font-bold" />
              <div className="h-12 w-12 bg-[#8670EF] rounded-full"></div>
            </>
            <p className="text-gray-800 text-3xl font-semibold">LEARNING BEE</p>
          </div>
          <div className="">
      ...
      <div className="h-24 w-24 lg:h-40 lg:w-40 border  border-gray-500 hover:pl-2  hover:pt-2 rounded-full absolute right-5 bottom-5">
                <div className="h-20 w-20 lg:h-36 lg:w-36  rounded-full hover:scale-110 duration-100 bg-[#8670EF] flex flex-col justify-center items-center">

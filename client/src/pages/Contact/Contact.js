    ...
    <div className='px-5 py-5 md:px-14  lg:px-12 xl:px-20 md:py-16'>
      ...
      <div className="flex items-center lg:justify-evenly flex-col md:flex-row-reverse lg:px-14">
        ...
        <div className='pl-5 lg:pl-10 xl:pl-20 w-full md:w-1/2'>
           <Lottie data-aos="zoom-out-left" loop={true} className='w-[200px] md:w-[270px] lg:w-[300px] xl:w-[400px]' animationData={envelop}/>
           </div>
            ...
            <form>
              <div className="flex flex-col items-center space-y-10 pb-14 pt-32 md:pt-28 md:pb-6 ">
                <input
                  name="name"
                  type="name"
                  className=" text-xl border-b-2 py-3 bg-[#18171C]  text-white w-4/5 focus-none focus:outline-none"
              ...
              <div className="h-24 w-24 lg:h-40 lg:w-40 border  border-gray-500 hover:pl-2  hover:pt-2 rounded-full ">
                <div className="h-20 w-20 lg:h-36 lg:w-36  rounded-full hover:scale-110 duration-200  bg-[#8670EF] flex flex-col justify-center items-center">

  ...
  return (
    <div id='contact' className='px-5 pb-5 pt-14 md:px-14  lg:px-12 xl:px-20 md:py-16'>
      ...
      <div className="flex items-center lg:justify-evenly flex-col md:flex-row-reverse lg:px-14">
        {/* left */}
        <div className='-pl-20 lg:pl-10 xl:pl-20 w-full md:w-1/2'>
           <Lottie data-aos="zoom-out-left" loop={true} className='h-[200px] w-[300px] md:w-[270px] lg:w-[300px] xl:h-[400px]  xl:w-[400px]' animationData={box}/>
           </div>
